...
| --------------- | --------------- | --------------- | ---------------|
| Genspeech | Assessing quality in low bit rate codecs | <sub> [./models/Sequential_model/Genspeech.zip](https://github.com/wjassim/WARP-Q/blob/main/models/Sequential_model/Genspeech.zip) </sub> | <sub> [./models/RandomForest_model/Genspeech.zip](https://github.com/wjassim/WARP-Q/blob/main/models/RandomForest_model/Genspeech.zip) </sub> |
| TCD‐VoIP | Assessing quality in VoIP applications | <sub> [./models/Sequential_model/TCDVoIP.zip](https://github.com/wjassim/WARP-Q/blob/main/models/Sequential_model/TCDVoIP.zip) </sub> | <sub> [./models/RandomForest_model/TCDVoIP.zip](https://github.com/wjassim/WARP-Q/blob/main/models/RandomForest_model/TCDVoIP.zip) </sub> |
| ITU‐T P. Supplement 23 (P.Sup23) | Interworking with wireless, transmission standards, and effect of channel degradations| <sub> [./models/Sequential_model/ITUTPSup23.zip](https://github.com/wjassim/WARP-Q/blob/main/models/Sequential_model/ITUTPSup23.zip) </sub>|  <sub>[./models/RandomForest_model/ITUTPSup23.zip](https://github.com/wjassim/WARP-Q/blob/main/models/RandomForest_model/ITUTPSup23.zip) </sub>|
| Genspeech + TCD-VoIP + P.Sup23 | Assessing overall quality | <sub> [./models/Sequential_model/Genspeech_TCDVoIP_ITUTPSup23.zip](https://github.com/wjassim/WARP-Q/blob/main/models/Sequential_model/Genspeech_TCDVoIP_ITUTPSup23.zip) </sub> | <sub> [./models/RandomForest_model/Genspeech_TCDVoIP_ITUTPSup23.zip](https://github.com/wjassim/WARP-Q/blob/main/models/RandomForest_model/Genspeech_TCDVoIP_ITUTPSup23.zip) </sub>|
